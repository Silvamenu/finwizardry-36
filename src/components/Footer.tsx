            ...
            <div className="flex space-x-4">
              {[
                ...
                <a 
                  ...
                  className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-100 text-gray-600 hover:bg-momoney-100 hover:text-momoney-600 transition-colors duration-300"
                >
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Recursos", "Preços", "Avaliações", "FAQ"].map((item, index) => (
                <li key={index}>
                  <a href="#" className="text-gray-600 hover:text-momoney-600 transition-colors duration-300">
                    {item}
                  </a>
                </li>
              ))}
