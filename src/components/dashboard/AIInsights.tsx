  ...
  return (
    <Card className="animate-fade-in reveal-delay-2">
      ...
      <CardContent className="space-y-6">
        {response && (
          <div className="bg-momoney-50 p-4 rounded-lg mb-4 border border-momoney-100 animate-fade-in">
            <div className="flex items-start">
              <AnimatedIcon 
                icon={Bot} 
                className="mt-1 mr-3 h-5 w-5 text-momoney-600" 
                animation="none"
              />
              <div>
                <h4 className="font-medium text-momoney-700 mb-1">Assistente IA</h4>
        ...
        <div className="relative">
          <div className="flex space-x-2">
            <div className="relative flex-1">
              <input
                ...
                className="w-full px-4 py-2 pr-10 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-momoney-500 focus:border-transparent"
                value={question}
              ...
              {thinking && (
                <div className="absolute right-3 top-2.5">
                  <div className="animate-pulse flex space-x-1">
                    <div className="h-2 w-2 bg-momoney-500 rounded-full"></div>
                    <div className="h-2 w-2 bg-momoney-500 rounded-full" style={{ animationDelay: "0.2s" }}></div>
                    <div className="h-2 w-2 bg-momoney-500 rounded-full" style={{ animationDelay: "0.4s" }}></div>
                  </div>
                </div>
              )}
            </div>
          ...
          <p className="mt-1 text-xs text-gray-500">Experimente: "Como posso investir melhor?" ou "Onde posso economizar?"</p>
        </div>
