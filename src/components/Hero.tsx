...
const Hero = () => {
  return (
    <section id="home" className="pt-32 pb-20 relative overflow-hidden">
      ...
      <div className="absolute -top-40 -right-40 w-96 h-96 bg-momoney-100 rounded-full blur-3xl opacity-50 animate-float"></div>
      <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-momoney-100 rounded-full blur-3xl opacity-50 animate-float" style={{ animationDelay: '2s' }}></div>
      
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 max-w-2xl mx-auto lg:mx-0">
            <div className="inline-flex items-center px-3 py-1.5 bg-momoney-100 text-momoney-700 rounded-full animate-fade-in">
              <span className="text-sm font-medium">O Futuro das Finanças Pessoais</span>
            </div>
            
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight animate-fade-in reveal-delay-1">
              <span className="gradient-text">Inteligência Financeira</span> ao seu alcance
            </h1>
            
            <p className="text-lg text-gray-700 animate-fade-in reveal-delay-2">
              O MoMoney é uma IA avançada que atua como seu consultor financeiro digital, ajudando você a gerenciar melhor suas finanças, economizar dinheiro e investir de forma inteligente.
            </p>
          ...
          <div className="relative lg:h-[500px] grid place-items-center">
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="w-full h-2 bg-gray-100 rounded-full overflow-hidden">
                    <div className="h-full bg-momoney-500 rounded-full" style={{width: '65%'}}></div>
                  </div>
                </div>
                ...
                <div className="bg-white p-4 rounded-xl border border-gray-100 animate-fade-in reveal-delay-3">
                  ...
                  <div className="flex justify-center py-2">
                    <AnimatedIcon icon={PieChart} className="w-24 h-24 text-momoney-500" animation="float" />
                  </div>
                </div>
            ...
            <div className="absolute -right-10 top-20 glass-card p-4 shadow-lg animate-fade-in reveal-delay-4 animate-float" style={{animationDelay: '1s'}}>
              <div className="flex items-center space-x-3">
                <AnimatedIcon 
                  icon={BarChart3} 
                  className="w-10 h-10 p-2 bg-momoney-100 rounded-lg text-momoney-600" 
                  animation="pulse"
                />
                <div>
