    ...
    return (
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-none group-data-[variant=floating]:border-0 group-data-[variant=floating]:shadow-xl"
          >
            {children}
          </div>
        </div>
